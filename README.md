...
| ◐ partially read | RefChecker: Reference-based Fine-grained Hallucination Checker and Benchmark for Large Language Models                                                                                          |  | 2024                   | LLM Evaluation             | paper           | this framework is also used in the RAGChecker paper                                                                        | https://arxiv.org/abs/2405.14486                                                                                                         |
...
| ❌ not started   | Two Tales of Persona in LLMs: A Survey of Role-Playing and Personalization                     |       | 2024                   | LLM Persona       | paper (survey) |                                                                              | <https://arxiv.org/abs/2406.01171>                                                                            |
| ❌ not started   | Quantifying the Persona Effect in LLM Simulations                                              |       | 2024                   | LLM Persona       | paper          | notes                                                                        | <https://arxiv.org/abs/2402.10811>                                                                            |
...
- (paper) RAGCHECKER: A Fine-grained Framework for Diagnosing Retrieval-Augmented Generation
